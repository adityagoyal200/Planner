                ...
                <div className="glass-card rounded-2xl p-5 relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className="ml-auto text-xs font-bold text-zinc-500 hover:text-rose-400 bg-zinc-900 hover:bg-rose-950 px-3 py-2 rounded-lg transition-colors cursor-pointer"
                        >
                            Sign Out
                        </button>
                    </div>
